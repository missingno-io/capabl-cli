...
class Exsistingproject extends Command {
	/**
	 ...
	 * @var string
	 */
	protected $description = 'Clones an existing Capabl project and attempts to setup the environment';
	...
	public function handle() {
		...
		$this->info( "Cloning Capabl project $name..." );
		$output = shell_exec( "git clone git@bitbucket.org:bmediallc/$name" );
